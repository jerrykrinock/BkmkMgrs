...
static const ExtoreConstants extoreConstants = {
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"Chromium",
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"org.chromium.Chromium"] ;
}
