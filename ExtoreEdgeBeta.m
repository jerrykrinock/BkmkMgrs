...
static const ExtoreConstants extoreConstants = {
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"Microsoft Edge Beta",
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"com.microsoft.edgemac.Beta"] ;
}
