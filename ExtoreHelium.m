...
static const ExtoreConstants extoreConstants = {
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"net.imput.helium",
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"net.imput.helium"] ;
}
