...
**Version 3.x is "paid" upgrade:** Free for users who purchased Version a prior version within the last 6 months, 65% discount if within the last 2 years, 30% discount if over 2 years.
