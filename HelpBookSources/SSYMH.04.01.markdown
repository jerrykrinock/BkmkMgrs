...
*Chrome-ish* refers to a web browser which is substantially built upon the [Chromium open-source project](http://code.google.com/intl/en/chromium/).  Such browsers include: Google Chrome, Google Chrome Canary, Brave, Edge, Comet, ChatGPT Atlas, [FreeSMUG's Chromium](http://www.freesmug.org/chromium), Opera (since version 15), Vivaldi, Orion, Helium, Maxthon, Epic, and probably more which may have come and gone by the time you read this!
