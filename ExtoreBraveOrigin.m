...
static const ExtoreConstants extoreConstants = {
	...
	/* ownerAppDisplayName */             @"Brave Origin",
	/* webHostName */                     nil,
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"BraveSoftware/Brave-Origin",
...
@implementation ExtoreBraveOrigin
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"com.brave.Browser.origin"] ;
}
