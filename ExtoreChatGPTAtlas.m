...
static const ExtoreConstants extoreConstants = {
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"com.openai.atlas/browser-data/host",
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"com.openai.atlas"] ;
}
...
+ (NSSet*)allProfilesThisHome {
    return [ExtoreChatGPTAtlas allProfilesThisHomeSwiftly];
}
