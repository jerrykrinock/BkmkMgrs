...
static const ExtoreConstants extoreConstants = {
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"Microsoft Edge Dev",
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"com.microsoft.edgemac.Dev"] ;
}
