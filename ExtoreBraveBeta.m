...
static const ExtoreConstants extoreConstants = {
	...
	/* ownerAppDisplayName */             @"Brave Beta",
	/* webHostName */                     nil,
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"BraveSoftware/Brave-Browser-Beta",
...
@implementation ExtoreBraveBeta
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"com.brave.Browser.beta"] ;
}
