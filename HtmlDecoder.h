...
/*!
 @brief    Provides a class method for parsing contents of HTML files
 into the localMoc of a given extore
*/
@interface HtmlDecoder : HtmlCodec {
...
/*!
 @brief    Parses given HTML data into the starker of a given extore.
