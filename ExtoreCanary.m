...
static const ExtoreConstants extoreConstants = {
	...
	/* ownerAppDisplayName */             @"Chrome Canary",
	/* webHostName */                     nil,
	...
	/* oAuthRealm */                      nil,
	/* appSupportRelativePath */          @"Google/Chrome Canary",
...
+ (NSArray*)browserBundleIdentifiers {
    return [NSArray arrayWithObject:@"com.google.Chrome.canary"] ;
}
